...
const NAV_TO = ['/', '/produits', '/solutions', '/tarifs', '/ressources', '/a-propos', '/carrieres', '/contact']

const TR: Record<Lang, Content> = {
  /* ═══════════════════════ FR ═══════════════════════ */
  fr: {
    nav: ['Accueil', 'Produits', 'Solutions', 'Tarifs', 'Ressources', 'À propos', 'Carrières', 'Contact'].map((label, i) => ({ label, to: NAV_TO[i] })),
    ...
    stats: [
      ...
      { value: '100%', label: 'Cloud & multi-tenant' }, { value: '🇩🇪', label: 'Hébergement Allemagne' },
    ],
    why: [
      ...
      { title: 'Cloud & multi-tenant', desc: 'Données strictement isolées par client, hébergement souverain en Allemagne, disponible partout.' },
    ...
    modules: {
      ...
      crm: { name: 'CRM', tagline: 'Relation client', desc: 'Prospects, opportunités, devis, contrats et relances commerciales.' },
      finance: { name: 'Finance', tagline: 'Finance & compta', desc: 'Facturation, caisse, comptabilité OHADA, tarification et recouvrement.' },
      inventory: { name: 'Inventory', tagline: 'Stocks & achats', desc: 'Articles, entrepôts, mouvements, inventaire et approvisionnements.' },
    },
    engines: [
    ...
    home: {
      eyebrow: 'ERP Cloud configurable · Plateforme SaaS modulaire',
      title1: 'TAS Platform.', title2: 'L’innovation au service de votre performance.',
      sub: 'Une seule plateforme ERP Cloud, des modules activables, des processus configurables. TAS s’adapte à votre entreprise — quel que soit votre secteur.',
      feats: ['Modules activables', 'Sans double saisie', 'Hébergé en Allemagne', 'App mobile terrain'],
      whyEyebrow: 'Pourquoi TAS', whyTitle: 'La plupart des ERP vous imposent leurs processus. TAS épouse les vôtres.',
    ...
    ctaDefault: { title: 'Prêt à voir TAS sur vos propres processus ?', sub: 'Réservez une démonstration : nous configurons la plateforme sur votre cas d’usage réel.' },
  },
  /* ═══════════════════════ EN ═══════════════════════ */
  en: {
    nav: ['Home', 'Products', 'Solutions', 'Pricing', 'Resources', 'About', 'Careers', 'Contact'].map((label, i) => ({ label, to: NAV_TO[i] })),
    cta: 'Request a demo', discover: 'Explore the platform', seeAll: 'See all modules',
    statuses: { live: 'Available', beta: 'Beta', soon: 'Soon' },
    stats: [{ value: '10+', label: 'Business modules' }, { value: '6', label: 'Industries covered' }, { value: '100%', label: 'Cloud & multi-tenant' }, { value: '🇩🇪', label: 'Hosted in Germany' }],
    why: [
      ...
      { title: 'Cloud & multi-tenant', desc: 'Strictly isolated data per client, sovereign hosting in Germany, available everywhere.' },
    ...
    modules: {
      ...
      crm: { name: 'CRM', tagline: 'Customer relations', desc: 'Leads, opportunities, quotes, contracts and follow-ups.' },
      finance: { name: 'Finance', tagline: 'Finance & accounting', desc: 'Invoicing, cash, OHADA accounting, pricing and collections.' },
      inventory: { name: 'Inventory', tagline: 'Stock & purchasing', desc: 'Items, warehouses, movements, stocktakes and procurement.' },
    },
    engines: [
    ...
    home: {
      eyebrow: 'Configurable Cloud ERP · Modular SaaS platform',
      title1: 'TAS Platform.', title2: 'Innovation at the service of your performance.',
      sub: 'One Cloud ERP platform, modules you switch on, processes you configure. TAS adapts to your business — whatever your industry.',
      feats: ['Modules on demand', 'No double entry', 'Hosted in Germany', 'Mobile field app'],
      whyEyebrow: 'Why TAS', whyTitle: 'Most ERPs impose their processes on you. TAS embraces yours.',
    ...
    ctaDefault: { title: 'Ready to see TAS on your own processes?', sub: 'Book a demo: we configure the platform on your real use case.' },
  },
  /* ═══════════════════════ DE ═══════════════════════ */
  de: {
    nav: ['Start', 'Produkte', 'Lösungen', 'Preise', 'Ressourcen', 'Über uns', 'Karriere', 'Kontakt'].map((label, i) => ({ label, to: NAV_TO[i] })),
    cta: 'Demo anfragen', discover: 'Plattform entdecken', seeAll: 'Alle Module ansehen',
    statuses: { live: 'Verfügbar', beta: 'Beta', soon: 'Bald' },
    stats: [{ value: '10+', label: 'Fachmodule' }, { value: '6', label: 'Branchen' }, { value: '100%', label: 'Cloud & mandantenfähig' }, { value: '🇩🇪', label: 'Hosting in Deutschland' }],
    why: [
      ...
      { title: 'Cloud & mandantenfähig', desc: 'Streng isolierte Daten je Kunde, souveränes Hosting in Deutschland, überall verfügbar.' },
    ...
    modules: {
      ...
      crm: { name: 'CRM', tagline: 'Kundenbeziehung', desc: 'Leads, Chancen, Angebote, Verträge und Nachfassaktionen.' },
      finance: { name: 'Finance', tagline: 'Finanzen & Buchhaltung', desc: 'Rechnung, Kasse, OHADA-Buchhaltung, Preise und Inkasso.' },
      inventory: { name: 'Inventory', tagline: 'Bestand & Einkauf', desc: 'Artikel, Lager, Bewegungen, Inventur und Beschaffung.' },
    },
    engines: [
    ...
    home: {
      eyebrow: 'Konfigurierbares Cloud-ERP · Modulare SaaS-Plattform',
      title1: 'TAS Platform.', title2: 'Innovation im Dienst Ihrer Leistung.',
      sub: 'Eine Cloud-ERP-Plattform, aktivierbare Module, konfigurierbare Prozesse. TAS passt sich Ihrem Unternehmen an — in jeder Branche.',
      feats: ['Module nach Bedarf', 'Keine Doppelerfassung', 'Hosting in Deutschland', 'Mobile Feld-App'],
      whyEyebrow: 'Warum TAS', whyTitle: 'Die meisten ERPs zwingen Ihnen ihre Prozesse auf. TAS übernimmt Ihre.',
    ...
    ctaDefault: { title: 'Bereit, TAS an Ihren Prozessen zu sehen?', sub: 'Buchen Sie eine Demo: Wir konfigurieren die Plattform auf Ihren realen Anwendungsfall.' },
  },
}
