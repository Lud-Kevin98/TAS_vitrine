...
const TR: Record<Lang, Content> = {
  ...
  fr: {
    ...
    home: {
      ...
      modEyebrow: 'Une plateforme, dix modules', modTitle: 'Ce que chaque module résout pour vous.',
    },
  ...
  en: {
    ...
    home: {
      ...
      modEyebrow: 'One platform, ten modules', modTitle: 'What each module solves for you.',
    },
  ...
  de: {
    ...
    home: {
      ...
      modEyebrow: 'Eine Plattform, zehn Module', modTitle: 'Was jedes Modul für Sie löst.',
    },
